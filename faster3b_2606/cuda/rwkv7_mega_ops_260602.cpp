...
void rwkv7_mega_rkv_lowrank_pre_executor_into_cuda(torch::Tensor xr, torch::Tensor xk, torch::Tensor xv, torch::Tensor wr, torch::Tensor wk, torch::Tensor wv, torch::Tensor yr, torch::Tensor yk, torch::Tensor yv, torch::Tensor xw, torch::Tensor xa, torch::Tensor xg, torch::Tensor xlr_v, torch::Tensor w1_t, torch::Tensor a1_t, torch::Tensor g1_t, torch::Tensor v1_t, torch::Tensor w2_t, torch::Tensor g2_t, torch::Tensor w1, torch::Tensor a1, torch::Tensor g1, torch::Tensor v1, torch::Tensor w, torch::Tensor g, torch::Tensor counter, torch::Tensor timeline, int64_t blocks, int64_t threads, int64_t lowrank_worker_budget, int64_t rkv_out_tile, int64_t force_task_sync, int64_t launch_min_blocks, int64_t early_wg_rankout, int64_t rkv_body_mode, int64_t role_order);
...
TORCH_LIBRARY_IMPL(rwkv7_mega_ops_260602, CUDA, m) {
    ...
    m.impl("rkv_lowrank_pre_executor_into", [](torch::Tensor xr, torch::Tensor xk, torch::Tensor xv, torch::Tensor wr, torch::Tensor wk, torch::Tensor wv, torch::Tensor yr, torch::Tensor yk, torch::Tensor yv, torch::Tensor xw, torch::Tensor xa, torch::Tensor xg, torch::Tensor xlr_v, torch::Tensor w1_t, torch::Tensor a1_t, torch::Tensor g1_t, torch::Tensor v1_t, torch::Tensor w2_t, torch::Tensor g2_t, torch::Tensor w1, torch::Tensor a1, torch::Tensor g1, torch::Tensor v1, torch::Tensor w, torch::Tensor g, torch::Tensor counter, torch::Tensor timeline, int64_t blocks, int64_t threads, int64_t lowrank_worker_budget, int64_t rkv_out_tile, int64_t force_task_sync, int64_t launch_min_blocks, int64_t early_wg_rankout, int64_t rkv_body_mode, int64_t role_order) {
        rwkv7_mega_rkv_lowrank_pre_executor_into_cuda(xr, xk, xv, wr, wk, wv, yr, yk, yv, xw, xa, xg, xlr_v, w1_t, a1_t, g1_t, v1_t, w2_t, g2_t, w1, a1, g1, v1, w, g, counter, timeline, blocks, threads, lowrank_worker_budget, rkv_out_tile, force_task_sync, launch_min_blocks, early_wg_rankout, rkv_body_mode, role_order);
    });
